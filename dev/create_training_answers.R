...
# 
# key2 <- c("none", txt[1], "none", "none", "none", txt[2], "none", txt[3])
# 
...
# 
# 
# #usethis::use_data(internal = T, overwrite = T, answers, eff_norms, main_concepts, mc_reference, scoring_mca, static_norms, sty, transcriptDefault, elements, keys)
